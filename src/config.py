...
SETTINGS = {
    ...
    # Only the default (i2) is released; the ablation variants have to be
    ...
    "i2": Setting(style="i2",    max_length=8192,
    ...
    "i7": Setting(style="i7",    max_length=8192, retriever="models/iter_i7"),
    "i2-4b": Setting(style="i2", max_length=8192,
