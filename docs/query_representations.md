...
| `i2` | + previous sub-queries (numbered, oldest→newest) | which directions were already explored |
...
| **`i7`** | i2 + a `Current Reasoning:` line before `Current Subquery:` | **the default** — reasoning added to the structured history |
