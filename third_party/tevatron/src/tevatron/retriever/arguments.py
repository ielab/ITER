...
class DataArguments:
    ...
    encode_sort_by_length: bool = field(
        default=False,
        metadata={"help": "sort the (sharded) corpus by text length before encoding, so each "
                          "batch is near-uniform length and padding is minimised"},
    )
